...
<head>
    ...
    <title>Report Found Item - UMPSA</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .form-row input:focus, .form-row textarea:focus { border-color: #00a896; background-color: #fff; }
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-card">
            <form id="foundReportForm" action="" method="POST" enctype="multipart/form-data">
                
                <div class="form-row">
                    <label>Item Name :</label>
                    <input type="text" name="item_name" placeholder="e.g. Student ID, Keys" required>
                </div>
    ...
    <script>
        document.getElementById('foundReportForm').onsubmit = function(e) {
            ...
            if (fileInput.files.length === 0) {
                alert("Please upload a picture of the item found.");
                return false;
            }
